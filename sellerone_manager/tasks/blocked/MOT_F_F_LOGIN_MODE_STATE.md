...
```json
{
  ...
  "forbidden_actions": "no F061 run; no F061 queue edit; no live scanner proof window; no handoff approval; no worker restart; no Google Sheets writes; no price changes; no local DB alignment; no output deletion; no scanner repair; no scope widening",
  "job_ref": "F-LOGIN-MODE",
  "last_seen_utc": "2026-06-05T15:34:13Z",
  "luke_action_required": "1",
  "manager_action": "Classify login recovery state before running any scanner proof.",
  "notes": "Read-only F MOT retest still fails f_login_mode_state=still_required. Fresh patched FPM130 would set login mode correctly, but live owner is pre-patch and continues minimized children. Needs the same controlled FPM130 owner reload proof as F-BBP-IFRAME-STALL; no F061 run, queue edit, browser opening, restart, Sheets, prices, DB alignment, or output deletion performed.",
  "observed_utc": "2026-06-05T15:34:13Z",
  "priority": "high",
  ...
  "updated_utc": "2026-06-05T15:34:37Z",
