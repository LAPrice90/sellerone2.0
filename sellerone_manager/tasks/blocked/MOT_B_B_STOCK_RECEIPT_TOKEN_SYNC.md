...
```json
{
  ...
  "forbidden_actions": "no B run or restart; no lock or maintenance marker edits; no Google Sheets writes; no price or queue changes; no token/data correction; no local DB alignment; no output deletion; no scope widening",
  "job_ref": "B-STOCK-RECEIPT-TOKEN",
  "last_seen_utc": "2026-06-05T11:21:54Z",
  "luke_action_required": "1",
  "manager_action": "Create or continue a bounded B task to prove the existing token creator path. Stop for Luke only before Sheet writes, token creation, stock correction, or live cycle action.",
  "notes": "Read-only staged Orders refresh created; live local Orders proof replacement would affect token creator source facts and needs protected approval.",
  "observed_utc": "2026-06-05T11:21:54Z",
  "priority": "normal",
  "producer": "B007_allocate_tokens_live.py / B004_build_order_master.py / process_stock_receipts_sheet.py",
  "proof_required": "Retest with `python -m sellerone_manager.app --hourly-mot --mot-flow B` and confirm `b_stock_receipt_token_sync` is ok.",
  "retest_command": "python -m sellerone_manager.app --hourly-mot --mot-flow B",
  "root_cause_guess": "Read-only receipt preview found either receipt rows or Orders shipment rows that are not yet proved in the local source files used by the normal token creator.",
  ...
  "updated_utc": "2026-06-05T11:23:31Z",
