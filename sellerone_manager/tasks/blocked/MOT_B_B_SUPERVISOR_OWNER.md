...
```json
{
  ...
  "notes": "B supervisor ownership proof is stale/dead. Resolving it would require protected B restart, lock action, or live B recovery approval.",
