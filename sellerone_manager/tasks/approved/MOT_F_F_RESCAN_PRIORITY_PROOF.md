...
```json
{
  ...
  "last_seen_utc": "2026-06-05T10:55:15Z",
  "luke_action_required": "0",
  "manager_action": "Needs protected decision: approve a preview-first F rescan recovery packet for the parked rows, or leave them parked. Do not rewrite queue/output rows from MOT. Preview exists: requeue=12;exhausted=75;source_blocked=3.",
  "notes": "Protected RESCAN preview applied after Luke approval: 12 retry rows added, 75 exhausted, 3 source-blocked, 178 screening rows updated; F MOT ok.",
  "observed_utc": "2026-06-05T10:55:15Z",
  "priority": "high",
  ...
  "updated_utc": "2026-06-05T10:55:38Z",
