...
## Manager Authority
- task_id: MGR_H_repair_out_systems_M_hourly_mot
- job_ref: H-ACTIVE-GROUP-OUT-02
- status: approved
...
- source_id: H_repair_out_systems_M_hourly_mot
...
```json
{
  ...
  "notes": "3 active FAIL/blocker rows found.",
  "observed_utc": "2026-05-30T19:58:17Z",
  "priority": "high",
  "proof_required": "Use guarded H isolation or scheduler-owned proof; confirm terminal and publish truth before claiming success.",
  "root_artifact": "out\\systems\\M\\hourly_mot_H.csv",
  "status": "proposed",
  "stop_condition": "Stop after manager classification, task packaging, and proof path are recorded for this flow.",
  "task_id": "H_repair_out_systems_M_hourly_mot",
  "task_type": "repair",
