...
LISTING_HISTORY_COMPAT = resolve_compat_path("listing_offer_history.csv", default_system="H")
...
def _update_latest_snapshot_pointer(snapshot_path: Path, latest_filename: str) -> None:
    ...
    try:
        ...
        print(f"WARN latest snapshot pointer update failed for {latest_filename}: {exc}")
