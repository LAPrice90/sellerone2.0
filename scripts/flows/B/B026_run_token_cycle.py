...
BASE_STEPS = [
    ("build_token_cogs_ledger", [str(resolve_script_path(ROOT / "scripts", "B025_build_token_cogs_ledger.py"))]),
    ("rebuild_level1_from_archive", ["scripts/one_off/T023_rebuild_level1_from_archive.py"]),
    ("build_order_master", [str(resolve_script_path(ROOT / "scripts", "B004_build_order_master.py"))]),
    ("build_token_tests_daily", ["scripts/one_off/T001_B011_build_token_tests_daily.py"]),
    ("build_token_daily_checklist", [str(resolve_script_path(ROOT / "scripts", "B014_build_token_daily_checklist.py"))]),
]
