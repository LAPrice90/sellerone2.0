...
def main() -> None:
    ...
    if WRITE_SHEETS:
        ...
        ledger = pd.read_csv(token_path, dtype=str).fillna("")
    ...
    if WRITE_SHEETS:
        ...
        # Write local ledger only (same resolved path we loaded from).
        token_path.parent.mkdir(parents=True, exist_ok=True)
        ledger.to_csv(token_path, index=False)
    ...
    print(
        {
            ...
            "ledger_written": "sheet" if WRITE_SHEETS else str(token_path),
        }
    )
