...
| RC-O-003 | O-003 | After approved H pause plus O candidate-only market scan, or next safe proof window | `out/systems/O/history/` and `out/systems/O/live/restock_profit_checks_live.csv` | 59 candidates either receive native market proof or remain held with clear missing-data reasons | Keep O buy rows blocked and inspect H/O market ownership first | Waiting for proof window |
