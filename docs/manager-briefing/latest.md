...
| M | main manager | Warning | 67% | Current Manager Task Board: 34 active cards, 11 not started, 0 in progress, 4 blocked, 18 parked. | Keep warning visible and continue only if it blocks today's restocking work. |
...
- F live scanner movement: Moving. td_synnex over 5 chunks and 66.5 minutes: pending 1000 to 915, drop 85, processed rows 125, memory blocks 0. Next: Keep watching until F MOT clears or the worker marks proof ready.
