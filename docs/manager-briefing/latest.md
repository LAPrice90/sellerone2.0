...
| M | main manager | Warning | 67% | Current Manager Task Board: 30 active cards, 5 not started, 0 in progress, 6 blocked, 19 parked. | Keep warning visible and continue only if it blocks today's restocking work. |
...
- F live scanner movement: Moving. td_synnex over 5 chunks and 22.3 minutes: pending 3570 to 3471, drop 99, processed rows 125, memory blocks 0. Next: Keep watching until F MOT clears or the worker marks proof ready.
