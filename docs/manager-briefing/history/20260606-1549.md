...
| M | main manager | Warning | 67% | Current Manager Task Board: 30 active cards, 7 not started, 0 in progress, 4 blocked, 19 parked. | Keep warning visible and continue only if it blocks today's restocking work. |
