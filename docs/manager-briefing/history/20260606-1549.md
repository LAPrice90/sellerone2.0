...
| M | main manager | Warning | 67% | Current Manager Task Board: 29 active cards, 5 not started, 0 in progress, 5 blocked, 19 parked. | Keep warning visible and continue only if it blocks today's restocking work. |
...
- F live scanner movement: Moving. td_synnex over 5 chunks and 38.9 minutes: pending 4224 to 4125, drop 99, processed rows 125, memory blocks 0. Next: Keep watching until F MOT clears or the worker marks proof ready.
